...
function addGame() {
  ...
  if (item === "") return alert("You need enter a Game Title");
...
function listGames() {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    list +=
      "<span class='btn btn-danger' onclick='deleteGame(" +
      i +
      ")'>delete</span></li>";
  }
...
function showGame() {
  ...
  document.querySelector("#gameToPlay").innerHTML = "g";
}
